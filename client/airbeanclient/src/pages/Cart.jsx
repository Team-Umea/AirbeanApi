...
const Cart = () => {
  ...
  const handleOrder = () => {
    if (!isAuthenticated) {
      ModalComponent.open(
        ({ close }) => (
          <div>
            <p className="my-6">Du måste vara inloggad för att slutföra din beställning.</p>
  ...
  return (
    <div className="cart-page">
      <h2 className="title-coofee mt-4 text-3xl font-bold text-amber-700">Din kaffekorg</h2>
